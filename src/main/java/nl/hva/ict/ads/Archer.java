...
public class Archer {
    ...
    /**
     * <b>This is a convenience constructor that only should be used by unit-tests!</b>.
     * The ID is not allowed to ever change during the lifetime of the instance! For this you need to use
     * the correct Java keyword.
     *
     ...
     * parameter holds the three scores, one for each arrow.
     *
